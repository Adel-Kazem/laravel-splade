...
@php
    ...
    // Merge the component's classes with any additional classes passed to it
    $mergedClasses = $attributes->get('class') ? $buttonClasses . ' ' . $attributes->get('class') : $buttonClasses;
@endphp
        ...
        @else
            <div class="flex flex-row items-center justify-center">
                <svg
                    ...
                    class="animate-spin mr-3 h-4 @if($type === 'white') text-gray-700 @else text-white @endif" 
